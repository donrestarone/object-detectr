...
TEST_IMAGE_PATHS = [ os.path.join(PATH_TO_TEST_IMAGES_DIR, sys.argv[1].format(i)) for i in range(1, 2) ]  # change this value if you want to add more pictures to test
...
with detection_graph.as_default():
    with tf.Session(graph=detection_graph) as sess:
        ...
        #   plt.savefig("outputs/detection_output{}.png".format(i))
          plt.savefig(f'outputs/{sys.argv[1]}.png')
          i = i+1